...
from blog.views import AboutView,PostListView,PostDetailView,CreatePostView,UpdatePostView,PostDeleteView,DraftListView,add_comment_to_post,comment_approve,comment_remove,post_publish,RuleListView,RuleDeleteView,CreateRuleView,RuleDetailView,UpdateRuleView,rule_publish,CreateRegsiterView,PaypalView
